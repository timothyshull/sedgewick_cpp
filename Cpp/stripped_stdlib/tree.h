#ifndef STRIPPED_STDLIB_TREE_H
#define STRIPPED_STDLIB_TREE_H
...
using std::__can_extract_key;
using std::__can_extract_map_key;
using std::__extract_key_fail_tag;
using std::__unconstref;
...
struct __tree_key_value_types<__value_type<_Key, _Tp> > {
    ...
    static __container_value_type *__get_ptr(__node_value_type &__n) {
        return std::addressof(__n.__cc);
    }

    static __nc_value_type &&__move(__node_value_type &__v) {
        return std::move(__v.__nc);
    }
};
...
public:
    ...
    friend
    bool operator==(const __tree_iterator &__x, const __tree_iterator &__y) { return __x.__ptr_ == __y.__ptr_; }
...
public:
    ...
    friend
    bool operator==(const __tree_const_iterator &__x, const __tree_const_iterator &__y) { return __x.__ptr_ == __y.__ptr_; }
...
private:
    ...
    const __node_allocator &__node_alloc() const noexcept { return __pair1_.second(); }
...
public:
    ...
    __node_pointer __root() const noexcept { return static_cast<__node_pointer>(__end_node()->__left_); }
    ...
    size_type max_size() const noexcept { return __node_traits::max_size(__node_alloc()); }
    ...
    __emplace_hint_unique_extract_key(const_iterator __p, _Pp &&__x, __extract_key_self_tag) {
        return __emplace_hint_unique_key_args(__p, __x, std::forward<_Pp>(__x));
    }
    ...
    __emplace_hint_unique_extract_key(const_iterator __p, _Pp &&__x, __extract_key_first_tag) {
        return __emplace_hint_unique_key_args(__p, __x.first, std::forward<_Pp>(__x));
    }
    ...
    iterator __insert_unique(const_iterator __p, __container_value_type &&__v) {
        return __emplace_hint_unique_key_args(__p, _NodeTypes::__get_key(__v), std::move(__v));
    }
    ...
    iterator lower_bound(const _Key &__v) { return __lower_bound(__v, __root(), __end_node()); }
    ...
    const_iterator lower_bound(const _Key &__v) const { return __lower_bound(__v, __root(), __end_node()); }
    ...
    iterator upper_bound(const _Key &__v) { return __upper_bound(__v, __root(), __end_node()); }
    ...
    const_iterator upper_bound(const _Key &__v) const { return __upper_bound(__v, __root(), __end_node()); }
...
private:
    ...
    noexcept(is_nothrow_move_assignable<__node_allocator>::value) { __node_alloc() = std::move(__t.__node_alloc()); }
        ...
        if (size() != 0) {
            ...
            try {
                while (__cache != nullptr && __t.size() != 0) {
                    __cache->__value_ = std::move(__t.remove(__t.begin())->__value_);
                    __node_pointer __next = __detach(__cache);
                    __node_insert_multi(__cache);
                    __cache = __next;
                }
