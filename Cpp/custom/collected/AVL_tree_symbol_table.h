...
//    Raw_node_pointer _next(Raw_node_pointer n) noexcept {
//        if (n->_right != nullptr) {
//            return _min(n->_right);
//        }
//        while (!(n == n->_parent->_left)) {
//            n = n->_parent;
//        }
//        return n->parent;
//    }
//
//    Raw_node_pointer _min(Raw_node_pointer n) noexcept {
...
//    }
//
//    Raw_node_pointer _max(Raw_node_pointer n) noexcept {
