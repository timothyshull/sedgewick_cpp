#ifndef COLLECTED_GRAPH_SYMBOL_TABLE_H
#define COLLECTED_GRAPH_SYMBOL_TABLE_H

#include <string>

class Graph_symbol_stable {
    int N, val;
...
public:
    Graph_symbol_stable() : head(0), N(0) {}
...
#endif // COLLECTED_GRAPH_SYMBOL_TABLE_H
