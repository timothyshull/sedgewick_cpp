...
syn match Load
'\(\(LD\|ST\)\(BU\|B\|WU\|W\|TU\|T\|OU\|O\|HT\|SF\|UNC\)\)\|STCO'  
syn match Comment '%.*'
syn match Hex '#\x*'
...
syn keyword InstructionSet1 NEG NEGU FLOT FLOTU FIX FIXU SFLOT SFLOTU
SWYM SYNC SYNCID SYNCD LDVTS
syn keyword InstructionSet2 LDA GETA 2ADDU 4ADDU 8ADDU 16ADDU SET SETH
SETMH SETML SETL
...
syn keyword Bitwise AND OR XOR ANDN ORN HAND NOR NXOR SL SLU SR SRU MOR
MXOR BDIF WDIF TDIF ODIF ANDH ANDNH ANDMH ANDNMH ANDML ANDNML ANDL ANDNL
ORH ORNH ORMH ORNMH ORML ORNML ORL ORNL SADD MUX 
syn keyword Jumps JMP GO PUSHJ PUSHGO POP BZ BNZ BN BNN BP BNP BOD BEV
syn keyword FloitingPoint FADD FSUB FMUL FDIV DREM FSQRT FINT SFLOT
SFLOTU
